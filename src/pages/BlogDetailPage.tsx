        ...
        <div className="relative z-10 mx-auto max-w-3xl px-6">
          ...
          <motion.article
            ...
            className="blog-article
              [&_h2]:font-display [&_h2]:text-xl [&_h2]:sm:text-[26px] [&_h2]:font-extrabold [&_h2]:text-white [&_h2]:mt-10 [&_h2]:sm:mt-14 [&_h2]:mb-4 [&_h2]:sm:mb-6 [&_h2]:pb-3 [&_h2]:border-b [&_h2]:border-white/[0.06]
              [&_h3]:font-display [&_h3]:text-lg [&_h3]:sm:text-xl [&_h3]:font-bold [&_h3]:text-white [&_h3]:mt-8 [&_h3]:mb-4
              [&_p]:text-white/70 [&_p]:leading-[1.85] [&_p]:my-3 [&_p]:sm:my-4 [&_p]:text-[14px] [&_p]:sm:text-[15px]
