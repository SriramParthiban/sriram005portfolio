            ...
            return (
              <FadeInSection key={exp.title + exp.company} delay={idx * 200}>
                <div className="relative">
                  ...
                  {/* Polaroid card */}
                  <div className={`ml-12 sm:ml-0 sm:w-[calc(50%-40px)] ${isLeft ? "sm:mr-auto" : "sm:ml-auto"}`}>
                    <motion.div
                    ...
                    >
                      ...
                      {/* Period — styled as a handwritten date in the corner */}
                      ...
                      {/* Divider line resembling photo border */}
