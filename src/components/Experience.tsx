...
const Experience = () => (
  <section id="experience" className="dark-section relative px-6 py-32 overflow-hidden">
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      <div className="absolute top-20 -right-20 h-[350px] w-[350px] rounded-full bg-primary/6 blur-[120px]" />
      <div className="absolute -bottom-20 left-0 h-[250px] w-[250px] rounded-full bg-accent/5 blur-[100px]" />
    </div>
